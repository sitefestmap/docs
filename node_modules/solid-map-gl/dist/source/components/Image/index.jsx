import { onCleanup, createSignal, createEffect, untrack, } from 'solid-js';
    ...
    const _createPattern = pattern => {
        ...
        return {
            ...
            render: function () {
                ...
                if (p.fill)
                    this.ctx.fill(new Path2D(p.path));
