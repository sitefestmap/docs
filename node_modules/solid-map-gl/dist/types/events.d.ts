import type { MapMouseEvent, MapTouchEvent, MapWheelEvent, MapDataEvent, MapBoxZoomEvent } from 'mapbox-gl';
type mapEventTypes = {
...
declare const mapEvents: string[];
...
declare const layerEvents: any[];
declare const drawEvents: any[];
type drawEventTypes = {
